...
namespace Microsoft.Samples.Kinect.ControlsBasics.DataModel
{
    ...
    public sealed class SampleDataSource
    {
        ...
        private static Uri darkGrayImage ; 
        private static Uri mediumGrayImage;
        private static Uri lightGrayImage = new Uri("assets/lightGray.png", UriKind.Relative);
        //change uri and send image path try to find where did i change picture
        //timer
        //number of returned images
        //zooming
        //minimize name space
        //style check app.xaml
        ...
        public SampleDataSource()
        {
            ...
            try
            {
                ...
                var result = client.DownloadString("https://api.instagram.com/v1/tags/جامعة_الملك_عبدالعزيز/media/recent?client_id=94502ba37b8c49e88686c657df3846d7&count=100");
                dynamic dyn = JsonConvert.DeserializeObject<dynamic>(result);
                ...
                {
                    //name
                  string s = data.user.full_name;

                    //image start---
                  string im = data.images.thumbnail.url;
                  string big_im = data.images.standard_resolution.url;
                  BitmapImage b = new BitmapImage();
                  b.BeginInit();
                  b.UriSource = new Uri(im, UriKind.RelativeOrAbsolute);
                  b.EndInit();      
                  darkGrayImage = new Uri(im, UriKind.RelativeOrAbsolute);
                  mediumGrayImage = new Uri(big_im, UriKind.RelativeOrAbsolute);
                    //image end----
    ...
    public abstract class SampleDataCommon : BindableBase
    {
        ...
        /// </summary>
        public static Uri baseUri = new Uri("pack://application:,,,/");
        ...
        protected SampleDataCommon(string uniqueId, string title, string subtitle, Uri imagePath, Uri description)
        {
        ...
        public ImageSource Big
        {
            get
            {
                if (this.big == null && this.description != null)
                {
                    this.big = new BitmapImage(new Uri(SampleDataCommon.baseUri, this.description));
                }
            ...
            set
            {
                ...
                this.SetProperty(ref this.big, value);
            }
        }
    ...
    public class SampleDataItem : SampleDataCommon
    {
        ...
        public SampleDataItem(string uniqueId, string title, string subtitle, Uri imagePath, Uri description, string content, SampleDataCollection group)
        ...
        public SampleDataItem(string uniqueId, string title, string subtitle, Uri imagePath, Uri description, string content, SampleDataCollection group, Type navigationPage)
            : base(uniqueId, title, subtitle, imagePath, description)
        {
            this.content = content;
            this.group = group;
        ...
        public ImageSource Ibig
        {
            get
            {
                if (this.bg == null && this.description != null)
                {
                    this.bg = new BitmapImage(new Uri(SampleDataCommon.baseUri, this.description));
                }
            ...
            {
                this.description = null;
                this.SetProperty(ref this.bg, value);
            }
        }
    }
    ...
    public class SampleDataCollection : SampleDataCommon, IEnumerable
    {
        ...
        public SampleDataCollection(string uniqueId, string title, string subtitle, Uri imagePath, Uri description)
            : base(uniqueId, title, subtitle, imagePath, description)
        {
